    ...
    def create_sector_team(self, sector: GICSSector) -> SectorTeam:
        ...
        fundamental_analyst = AnalystAgent(
            ...
            + [
                ...
                "💡 **1단계: 시계열 트렌드 분석 (ChatGPT 지적사항 1 해결)**",
                ...
                "📊 **2단계: 경쟁사 및 벤치마크 비교 분석 (ChatGPT 지적사항 2,3 해결)**",
                ...
                "🔍 **3단계: 이상 변화 설명 및 질적 분석 (ChatGPT 지적사항 4,6 해결)**",
                ...
                "🎯 **4단계: 완성된 밸류에이션 분석 (ChatGPT 지적사항 5 해결)**",
