...
Q2: 이 기업의 성장성과 수익성 전망은 어떤가?
  └─ Q2-1: 과거 3년간 매출과 이익 성장 추세는?
    • [Fact Layer] 매출 성장률: 2022년 [수치]%, 2023년 [수치]%, 2024년 예상 [수치]% **[출처]**
    • [Fact Layer] 영업이익 성장률: 2022년 [수치]%, 2023년 [수치]%, 2024년 예상 [수치]% **[출처]**
    • [Fact Layer] 순이익 성장률: 2022년 [수치]%, 2023년 [수치]%, 2024년 예상 [수치]% **[출처]**
