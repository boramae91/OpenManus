...
Q4: 주요 리스크와 기회 요인은 무엇인가?
  └─ Q4-1: 재무적/운영적 리스크는 무엇인가?
    • 부채 리스크: [구체적 내용과 수치] **[출처]**
    • 환율 리스크: [구체적 내용과 수치] **[출처]**
    • 원자재 가격 리스크: [구체적 내용과 수치] **[출처]**
...
"""
  ...
  └─ Q5-1: 유가 및 가스 가격 민감도 관련 경쟁력은 어떤가?
    ...
    • [Fact Layer] 유가 민감도: [구체적 수치]% **[출처]**
    • [Fact Layer] 가스 가격 연동성: [구체적 수치] **[출처]**
    • [Fact Layer] 원가 구조: 생산단가 vs 판매단가 [구체적 분석] **[출처]**
    • [Interpretation Layer] 가격 민감도 영향 평가: [구체적 분석] **[출처]**
    • [Peer Benchmark] 업계 평균 대비 민감도: [구체적 비교] **[출처]**
    • [Chain of Reasoning] 가격 변동이 수익성에 미치는 영향: [구체적 분석] **[출처]**
  └─ Q5-2: 자원 매장량 및 수명 관련 경쟁력은 어떤가?
    • [Self-Ask] 자원 매장량이 기업 가치에 미치는 영향은?
    • [ReAct] 매장량 데이터 수집 → 생산량 대비 분석 → 수명 추정
    • [Fact Layer] 매장량 대비 생산량: [구체적 수치] **[출처]**
    • [Fact Layer] 자원 수명: [구체적 수치]년 **[출처]**
    • [Fact Layer] 탐사 성공률: [구체적 수치]% **[출처]**
    • [Interpretation Layer] 자원 지속가능성 평가: [구체적 분석] **[출처]**
    • [Peer Benchmark] 업계 평균 대비 자원 수명: [구체적 비교] **[출처]**
    • [Chain of Reasoning] 자원 고갈이 기업 가치에 미치는 영향: [구체적 분석] **[출처]**
  └─ Q5-3: Capex(탐사/시추/인프라 투자) 관련 경쟁력은 어떤가?
    • [Self-Ask] Capex 투자가 에너지 기업의 경쟁력에 미치는 영향은?
    • [ReAct] Capex 투자액 수집 → 수익률 분석 → 인프라 현황 평가
    • [Fact Layer] Capex 투자액: [구체적 수치]억원 **[출처]**
    • [Fact Layer] 투자 대비 수익률: [구체적 수치]% **[출처]**
    • [Fact Layer] 인프라 구축 현황: [구체적 내용] **[출처]**
    • [Interpretation Layer] 투자 효율성 평가: [구체적 분석] **[출처]**
    • [Peer Benchmark] 업계 평균 대비 Capex 수준: [구체적 비교] **[출처]**
    • [Chain of Reasoning] Capex 투자가 미래 성장에 미치는 영향: [구체적 분석] **[출처]**
  └─ Q5-4: ESG 요인(탄소배출, 규제 리스크) 관련 경쟁력은 어떤가?
    • [Self-Ask] ESG 요인이 에너지 섹터에 미치는 영향은?
    • [ReAct] ESG 데이터 수집 → 규제 환경 분석 → 대응 전략 평가
    • [Fact Layer] 탄소 배출량: [구체적 수치]톤 **[출처]**
    • [Fact Layer] ESG 등급: [구체적 등급] **[출처]**
    • [Fact Layer] 친환경 투자 비중: [구체적 수치]% **[출처]**
    • [Interpretation Layer] ESG 경쟁력 평가: [구체적 분석] **[출처]**
    • [Peer Benchmark] 업계 평균 대비 ESG 수준: [구체적 비교] **[출처]**
    • [Chain of Reasoning] ESG 요인이 기업 가치에 미치는 영향: [구체적 분석] **[출처]**
  └─ Q5-리스크: 자원 고갈 또는 탈탄소 정책 변화에 따른 구조적 리스크는?
    • [Self-Ask] 구조적 리스크가 에너지 섹터에 미치는 영향은?
    • [ReAct] 정책 변화 분석 → 리스크 요인 식별 → 대응 방안 검토
    • [Fact Layer] 탈탄소 정책 대응: [구체적 내용] **[출처]**
    • [Fact Layer] 신재생에너지 전환 계획: [구체적 내용] **[출처]**
    • [Fact Layer] 규제 리스크: [구체적 내용] **[출처]**
    • [Interpretation Layer] 구조적 리스크 영향도 평가: [구체적 분석] **[출처]**
    • [Peer Benchmark] 업계 평균 대비 리스크 노출도: [구체적 비교] **[출처]**
    • [Chain of Verification] 리스크 대응 전략의 효과성 검증: [구체적 분석] **[출처]**""",
            GICSSector.MATERIALS: f"""Q5: {emoji} {korean_name} 섹터 특화 분석 질문들:
  └─ Q5-1: 제품 가격 vs 원재료 가격 스프레드 관련 경쟁력은 어떤가?
    • 원자재 가격 연동성: [구체적 수치] **[출처]**
    • 제품-원료 가격 스프레드: [구체적 수치] **[출처]**
    • 가격 전가 능력: [구체적 수치]% **[출처]**
  └─ Q5-2: 재고자산 및 가격 변동성 관련 경쟁력은 어떤가?
    • 재고자산 회전율: [구체적 수치]회 **[출처]**
    • 가격 변동성: [구체적 수치]% **[출처]**
    • 재고 관리 효율성: [구체적 분석] **[출처]**
  ...
  └─ Q5-리스크: 환경 규제 강화에 따른 비용 상승 가능성은?
    • 환경 투자비용: [구체적 수치]억원 **[출처]**
    • 재활용률: [구체적 수치]% **[출처]**
    • 규제 대응 비용: [구체적 수치]억원 **[출처]**""",
  ...
  └─ Q5-2: 매출성장률과 이익률 추이 관련 경쟁력은 어떤가?
    • 동일매장 매출성장률: [구체적 수치]% **[출처]**
    • 마진율 추이: [구체적 분석] **[출처]**
    • 수익성 개선: [구체적 수치]% **[출처]**
  └─ Q5-3: e-Commerce 대응 전략 관련 경쟁력은 어떤가?
    • 온라인 매출 비중: [구체적 수치]% **[출처]**
    • 디지털 전환 투자: [구체적 수치]억원 **[출처]**
    • O2O 전략: [구체적 내용] **[출처]**
  ...
  └─ Q5-1: 파이프라인(신약개발 단계) 관련 경쟁력은 어떤가?
    ...
    • [Fact Layer] 신약 파이프라인: [구체적 수치]개 **[출처]**
    • [Fact Layer] 임상시험 성공률: [구체적 수치]% **[출처]**
    • [Fact Layer] 개발 단계별 분포: [구체적 분석] **[출처]**
    • [Interpretation Layer] 파이프라인 경쟁력 평가: [구체적 분석] **[출처]**
    • [Peer Benchmark] 업계 평균 대비 파이프라인 규모: [구체적 비교] **[출처]**
    • [Chain of Reasoning] 파이프라인이 미래 매출에 미치는 영향: [구체적 분석] **[출처]**
  └─ Q5-2: FDA 승인 및 특허만료 이슈 관련 경쟁력은 어떤가?
    • [Self-Ask] FDA 승인과 특허가 헬스케어 기업 가치에 미치는 영향은?
    • [ReAct] FDA 승인 현황 분석 → 특허 만료일정 검토 → 제네릭 위협 평가
    • [Fact Layer] FDA 승인 현황: [구체적 수치]개 **[출처]**
    • [Fact Layer] 특허 만료일정: [구체적 분석] **[출처]**
    • [Fact Layer] 제네릭 위협: [구체적 내용] **[출처]**
    • [Interpretation Layer] 승인 및 특허 리스크 평가: [구체적 분석] **[출처]**
    • [Peer Benchmark] 업계 평균 대비 FDA 승인 성공률: [구체적 비교] **[출처]**
    • [Chain of Reasoning] 특허 만료가 매출에 미치는 영향: [구체적 분석] **[출처]**
  └─ Q5-3: 보험 수가 및 정부 규제 정책 관련 경쟁력은 어떤가?
    • [Self-Ask] 규제 환경이 헬스케어 기업의 수익성에 미치는 영향은?
    • [ReAct] 보험 수가 현황 분석 → 규제 정책 검토 → 가격 책정 자유도 평가
    • [Fact Layer] 보험 수가 현황: [구체적 분석] **[출처]**
    • [Fact Layer] 정부 규제 정책: [구체적 내용] **[출처]**
    • [Fact Layer] 가격 책정 자유도: [구체적 수치]% **[출처]**
    • [Interpretation Layer] 규제 환경 영향도 평가: [구체적 분석] **[출처]**
    • [Peer Benchmark] 업계 평균 대비 규제 리스크: [구체적 비교] **[출처]**
    • [Chain of Reasoning] 규제 변화가 수익성에 미치는 영향: [구체적 분석] **[출처]**
  └─ Q5-4: R&D 비중 및 성공률 관련 경쟁력은 어떤가?
    • [Self-Ask] R&D 투자가 헬스케어 기업의 경쟁력에 미치는 영향은?
    • [ReAct] R&D 투자비율 분석 → 성공률 평가 → 매출 가시성 검토
    • [Fact Layer] R&D 투자비율: [구체적 수치]% **[출처]**
    • [Fact Layer] R&D 성공률: [구체적 수치]% **[출처]**
    • [Fact Layer] 매출 가시성: [구체적 수치]년 **[출처]**
    • [Interpretation Layer] R&D 효율성 평가: [구체적 분석] **[출처]**
    • [Peer Benchmark] 업계 평균 대비 R&D 투자 수준: [구체적 비교] **[출처]**
    • [Chain of Reasoning] R&D 투자가 미래 성장에 미치는 영향: [구체적 분석] **[출처]**
  └─ Q5-리스크: 신약 승인 실패 시 가치 급락 가능성은?
    • [Self-Ask] 승인 실패가 헬스케어 섹터에 미치는 구조적 리스크는?
    • [ReAct] 승인 실패 리스크 분석 → 대체 파이프라인 검토 → 리스크 분산 평가
    • [Fact Layer] 승인 실패 리스크: [구체적 수치]% **[출처]**
    • [Fact Layer] 대체 파이프라인: [구체적 내용] **[출처]**
    • [Fact Layer] 리스크 분산: [구체적 내용] **[출처]**
    • [Interpretation Layer] 승인 실패 리스크 영향도 평가: [구체적 분석] **[출처]**
    • [Peer Benchmark] 업계 평균 대비 승인 실패 리스크: [구체적 비교] **[출처]**
    • [Chain of Verification] 승인 실패 대응 전략의 효과성 검증: [구체적 분석] **[출처]**""",
  ...
  └─ Q5-1: 이자이익(NIM)과 비이자이익 구분 관련 경쟁력은 어떤가?
    ...
    • [Fact Layer] 순이자마진(NIM): [구체적 수치]% **[출처]**
    • [Fact Layer] 비이자수익: [구체적 수치]억원 **[출처]**
    • [Fact Layer] 수익 다변화: [구체적 수치]% **[출처]**
    • [Interpretation Layer] 수익 구조 안정성 평가: [구체적 분석] **[출처]**
    • [Peer Benchmark] 업계 평균 대비 수익 다변화: [구체적 비교] **[출처]**
    • [Chain of Reasoning] 수익 구조가 기업 가치에 미치는 영향: [구체적 분석] **[출처]**
  └─ Q5-2: 자산건전성(NPL, 대손충당금) 관련 경쟁력은 어떤가?
    • [Self-Ask] 자산건전성이 금융 기업의 핵심 경쟁력인 이유는?
    • [ReAct] NPL/대손충당금 데이터 수집 → 자산 품질 분석 → 건전성 평가
    • [Fact Layer] 신용비용률: [구체적 수치]% **[출처]**
    • [Fact Layer] 대손충당금 적정성: [구체적 수치]% **[출처]**
    • [Fact Layer] 자산 건전성: [구체적 분석] **[출처]**
    • [Interpretation Layer] 자산 품질 평가: [구체적 분석] **[출처]**
    • [Peer Benchmark] 업계 평균 대비 자산건전성: [구체적 비교] **[출처]**
    • [Chain of Reasoning] 자산건전성이 수익성에 미치는 영향: [구체적 분석] **[출처]**
  └─ Q5-3: 자본비율(BIS) 관련 경쟁력은 어떤가?
    • [Self-Ask] 자본비율이 금융 기업의 위험 관리에 미치는 영향은?
    • [ReAct] BIS 비율 계산 → ROE 분석 → 자본 효율성 평가
    • [Fact Layer] BIS 비율: [구체적 수치]% **[출처]**
    • [Fact Layer] ROE: [구체적 수치]% **[출처]**
    • [Fact Layer] 자본 효율성: [구체적 분석] **[출처]**
    • [Interpretation Layer] 자본 적정성 평가: [구체적 분석] **[출처]**
    • [Peer Benchmark] 업계 평균 대비 자본비율: [구체적 비교] **[출처]**
    • [Chain of Reasoning] 자본비율이 성장성에 미치는 영향: [구체적 분석] **[출처]**
  └─ Q5-4: 금리 민감도 및 레버리지 수준 관련 경쟁력은 어떤가?
    • [Self-Ask] 금리 민감도가 금융 기업의 수익성에 미치는 영향은?
    • [ReAct] 금리 민감도 분석 → 레버리지 수준 평가 → 리스크 관리 검토
    • [Fact Layer] 금리 민감도: [구체적 수치] **[출처]**
    • [Fact Layer] 레버리지 수준: [구체적 수치] **[출처]**
    • [Fact Layer] 금리 리스크 관리: [구체적 내용] **[출처]**
    • [Interpretation Layer] 금리 리스크 평가: [구체적 분석] **[출처]**
    • [Peer Benchmark] 업계 평균 대비 금리 민감도: [구체적 비교] **[출처]**
    • [Chain of Reasoning] 금리 변동이 수익성에 미치는 영향: [구체적 분석] **[출처]**
  └─ Q5-리스크: 장단기 금리 역전 시 수익성 악화 가능성은?
    • [Self-Ask] 금리 역전이 금융 섹터에 미치는 구조적 리스크는?
    • [ReAct] 금리 역전 시나리오 분석 → 수익성 영향 평가 → 대응 전략 검토
    • [Fact Layer] 금리 역전 리스크: [구체적 수치]% **[출처]**
    • [Fact Layer] 수익성 영향: [구체적 분석] **[출처]**
    • [Fact Layer] 대응 전략: [구체적 내용] **[출처]**
    • [Interpretation Layer] 금리 역전 리스크 영향도 평가: [구체적 분석] **[출처]**
    • [Peer Benchmark] 업계 평균 대비 금리 역전 리스크: [구체적 비교] **[출처]**
    • [Chain of Verification] 금리 역전 대응 전략의 효과성 검증: [구체적 분석] **[출처]**""",
            GICSSector.INFORMATION_TECHNOLOGY: f"""Q5: {emoji} {korean_name} 섹터 특화 분석 질문들:
  └─ Q5-1: 기술력(특허, 플랫폼 점유율) 관련 경쟁력은 어떤가?
    • 핵심 기술 특허 수: [구체적 수치]개 **[출처]**
    • 시장 점유율: [구체적 수치]% **[출처]**
    • 기술 격차: 경쟁사 대비 [구체적 내용] **[출처]**
  └─ Q5-2: 매출성장률/고객 락인효과 관련 경쟁력은 어떤가?
    • 매출 성장률: [구체적 수치]% **[출처]**
    • 고객 락인효과: [구체적 수치] **[출처]**
    • 스위칭 코스트: [구체적 내용] **[출처]**
  └─ Q5-3: R&D 투자 vs 수익화 성공률 관련 경쟁력은 어떤가?
    • R&D 투자액: [구체적 수치]억원 **[출처]**
    • 매출 대비 R&D 비율: [구체적 수치]% **[출처]**
    • 수익화 성공률: [구체적 수치]% **[출처]**
