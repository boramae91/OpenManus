...
- 투자 논리: [핵심 투자 포인트 3가지]
- 주요 리스크: [핵심 위험 요소 2가지]
- **섹터 경쟁력**: [Q5 분석 기반 섹터 내 위치와 차별화 요소]
- 투자 기간: [권장 투자 기간과 전략]
```
...
3. **Q5 섹터 특화 분석을 3단계 CoT에서 반드시 포함할 것**
4. Self-Critique에서 최소 3가지 이상의 비판적 관점 제시할 것
5. 모든 결론에 구체적 근거와 수치 제시할 것
6. 불확실성과 한계점을 솔직하게 인정할 것
7. **최종 의견에 섹터 특화 경쟁력 평가 포함할 것**
"""
...
"""
    ...
    def get_senior_report_synthesis_framework() -> str:
        """
        애널리스트 리포트를 위한 전문가 의견 종합 프레임워크를 반환합니다.
