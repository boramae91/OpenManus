...
# -*- coding: utf-8 -*-
"""
🚀 100만 글자 대용량 PDF 분석 시스템

이 스크립트는 100만 글자 정도의 대용량 사업보고서나 분기보고서를
...
async def main():
    ...
    print("=" * 50)
    print("이 시스템은 100만 글자까지의 대용량 보고서를 AI로 분석해서")
